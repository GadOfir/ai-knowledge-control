#   
README.md – System Operational Master V1.1
...
Active Context: [CID: `<Registry ID>` | Task: `<Current Operation Description>`] RULE: Use <OPTIONAL_INPUT> for undecided fields or leave blank. Add only when information is solid and not speculative.
